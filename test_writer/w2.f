...
c
     ...
     &                       ptr_ch(char(0)),
     &                       ptr_ch(char(0)))
      call fcreate_pointing_sector2(ptr_ch('ccwl'//char(0)),
     &                       ptr_ch('az'//char(0)),
     &                       ptr_ch('-90'//char(0)),
     &                       ptr_ch('deg'//char(0)),
     &                       ptr_ch('90'//char(0)),
     ...
     &                       ptr_ch(char(0)),
     &                       ptr_ch('ccw'//char(0)))
      call fcreate_pointing_sector2(ptr_ch('cwl'//char(0)),
     &                       ptr_ch('az'//char(0)),
     &                       ptr_ch('270'//char(0)),
     &                       ptr_ch('deg'//char(0)),
     &                       ptr_ch('450'//char(0)),
...
c
     ...
     &                         ptr_ch(char(0)))
      call fend_def
c
      call fcreate_def(ptr_ch('DeathAsteroid'//char(0)))
      call fcreate_source_type2(ptr_ch('ephemeris'//char(0)),
     &                         ptr_ch(char(0)),
     &                         ptr_ch('retarded'//char(0)))
      call fcreate_vector(ptr_ch('2010y270d18h00m00s'//char(0)),
     &                   ptr_ch('0'//char(0)),
     &                   ptr_ch('km'//char(0)),
     &                   ptr_ch('1'//char(0)),
     &                   ptr_ch('cm'//char(0)),
     ...
     &                   ptr_ch('um/yr'//char(0)),
     &                   ptr_ch('4'//char(0)),
     &                   ptr_ch('mm/sec'//char(0)),
     &                   ptr_ch('5'//char(0)),
     &                   ptr_ch('ft/day'//char(0)))
      call fcreate_vector(ptr_ch('2010y270d18h00m00s'//char(0)),
     &                   ptr_ch('0'//char(0)),
     &                   ptr_ch('km'//char(0)),
     &                   ptr_ch('1'//char(0)),
     ...
     &                   ptr_ch('5'//char(0)),
     &                   ptr_ch('ft/day'//char(0)))
      call fcreate_ref_coord_frame(ptr_ch('GCRF'//char(0)))
      call fend_def
c
